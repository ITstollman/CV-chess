...
  - crecollect Data from physical board. 
...
   
   :chess_pawn:-attack squares in relation to defender squares.
   
   :chess_pawn:-castle.
   
...
   
   It's important to mention that these evaluation functions are only a fraction from possible evaluation functions.
   
   
   
...
creates the data using computer vision techniques. classifies squares to different classe folders.
...
- explore a larger range of shooting angles.
